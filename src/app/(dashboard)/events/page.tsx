        ...
        <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                <div>
                    ...
                    <p style={{ color: 'var(--color-text-secondary)' }}>BitÃ¡cora y GestiÃ³n de Simulacros</p>
                </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '2rem' }}>
                <div className="card">
                    <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        ...
                        BitÃ¡cora de Actividades Diarias
                    </h3>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        {[
                            { time: '07:00 AM', activity: 'Cambio de Guardia', officer: 'Sgto. PÃ©rez' },
                            { time: '08:30 AM', activity: 'RevisiÃ³n de VehÃ­culos', officer: 'Cabo Ruiz' },
                            { time: '10:00 AM', activity: 'CapacitaciÃ³n: RCP BÃ¡sico', officer: 'Teniente Gomez' },
                        ].map((log, index) => (
                ...
                <div className="card">
                    <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: '1rem' }}>PrÃ³ximos Simulacros</h3>
                    <div style={{ padding: '1rem', backgroundColor: '#EFF6FF', borderRadius: '6px', border: '1px solid #BFDBFE' }}>
                        ...
                        <p style={{ fontSize: '0.875rem', color: '#60A5FA' }}>EvacuaciÃ³n por Sismo</p>
                    </div>
                </div>
            </div>
        </div>
